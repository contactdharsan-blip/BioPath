...
export const PathwaysList: React.FC<PathwaysListProps> = ({ pathways }) => {
  ...
  return (
    <Card className="animate-slide-up">
      <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Affected Pathways</h3>
          ...
          >
            <div className="flex items-start justify-between mb-2">
              <div className="flex-1">
                <h4 className="font-medium text-gray-900 dark:text-white">{pathway.pathway_name}</h4>
                {pathway.pathway_url && (
                  <a
                    href={pathway.pathway_url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 hover:underline mt-1 inline-block"
                  >
                    View on Reactome
                  </a>
                )}
